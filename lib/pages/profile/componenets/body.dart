...
class _BodyState extends State<Body> {
  ...
  @override
  void initState() {
    nameController.text = 'Mouhcine Daali';
    emailController.text = 'the.daali.mouhcine@gmail.com';
    birthdayController.text = '28/01/2001';
    super.initState();
  }
            ...
            child: Row(
              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    child: Image(
                      image: const AssetImage('assets/icons/back.png'),
